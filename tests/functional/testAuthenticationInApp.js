  ...
  describe('auth in app related telemetry tests', () => {
    ...
    describe("authentication started screen", async () => {
        ...
        it("impression event is recorded", async () => {
            const  enterEmailViewEvent = await vpn.gleanTestGetValue("impression", "enterEmailView", "main");
            ...
            assert.strictEqual("impression", enterEmailViewEventExtras.action);
        });
        ...
        it("back button event is recorded", async () => {
            ...
            await vpn.testLastInteractionEvent({
                eventName: "authenticationAborted",
                elementId: "back_arrow",
                screen,
            });
        });
        ...
        it("continue button event is recorded", async () => {
            ...
            await vpn.waitForQueryAndClick(
                queries.screenAuthenticationInApp.AUTH_START_BUTTON.visible()
                    .enabled());
            await vpn.testLastInteractionEvent({
                eventName: "authenticationInappStep",
                elementId: "continue",
                screen
            });
        });
    ...
    describe("sign in screen", async () => {
        ...
        it("impression event is are recorded", async () => {
            const  enterPasswordViewEvent = await vpn.gleanTestGetValue("impression", "authenticationInappStep", "main");
            ...
            assert.strictEqual("impression", enterPasswordViewEventExtras.action);
        });
        ...
        it("forgot password button event is recorded", async () => {
            ...
            await vpn.testLastInteractionEvent({
                eventName: "authPasswordResetRequest",
                elementId: "forgot_your_password",
                screen
            });
        });
        ...
        it("signin button event and outcome event are recorded", async () => {
            ...
            const startedOutcomeExtras = startedOutcomeEvent[0].extra;
            assert.strictEqual("login_started", startedOutcomeExtras.outcome);
            ...
            const endedOutcomeExtras = endedOutcomeEvent[0].extra;
            assert.strictEqual("login_ended", endedOutcomeExtras.outcome);
        });
    });
    ...
    describe("unblock code screen", async () => {
        ...
        it("impression event is recorded", async () => {
            const  unblockCodeViewEvent = await vpn.gleanTestGetValue("impression", "authenticationInappStep", "main");
            ...
            assert.strictEqual("impression", unblockCodeViewEventExtras.action);
        });
        ...
        it("resend code button event is recorded", async () => {
            ...
            await vpn.testLastInteractionEvent({
                eventName: "authVerificationCodeResend",
                elementId: "resend_code",
                screen
            });
        });
        ...
        it("verify button events are recorded", async () => {
            ...
            assert.strictEqual("two_fa_verification_failed", failedOutcomeExtras.outcome);
            ...
            assert.strictEqual("two_fa_verification_succeeded", successOutcomeExtras.outcome);
    ...
    describe("create password screen", async () => {
        ...
        it("impression event is recorded", async () => {
            const  createPasswordViewEvent = await vpn.gleanTestGetValue("impression", "authenticationInappStep", "main");
            ...
            assert.strictEqual("impression", createPasswordViewEventExtras.action);
        });
        ...
        it("create account button event and outcome event are recorded", async () => {
            ...
            await vpn.testLastInteractionEvent({
                eventName: "authenticationInappStep",
                elementId: "create_account",
                screen
            });

            const startedEvent = await vpn.gleanTestGetValue("outcome", "registrationStarted", "main");
            assert.strictEqual(startedEvent.length, 1);
            const startedExtras = startedEvent[0].extra;
            assert.strictEqual("registration_started", startedExtras.outcome);
            ...
            const completedOutcomeExtras = completedOutcomeEvent[0].extra;
            assert.strictEqual("registration_completed", completedOutcomeExtras.outcome);
        });
    });
    ...
    describe("email verification screen", async () => {
        ...
        it("impression event is recorded", async () => {
            const  verificationViewEvent = await vpn.gleanTestGetValue("impression", "authenticationInappStep", "main");
            // We are expecting two events here, because the create_password screen recorded one already.
            assert.strictEqual(verificationViewEvent.length, 2)
            const verificationViewEventExtras = verificationViewEvent[1].extra;
            assert.strictEqual(screen, verificationViewEventExtras.screen);
            assert.strictEqual("impression", verificationViewEventExtras.action);
        });
    ...
    describe("TOTP verification screen", async () => {
        const screen = "enter_totp_verification_code";
        ...
        it("close button event is recorded", async () => {
            // Click the "Close" button
            await vpn.waitForQueryAndClick(queries.screenAuthenticationInApp.AUTH_TOTP_BACK_BUTTON.visible());
            await vpn.testLastInteractionEvent({
                eventName: "authenticationInappStep",
                elementId: "close",
                screen
